...
namespace GameBoyEmulator {
	...
	int CPU::BIT_0_MHL()
	{
		BIT_u3_8bitRegister(0, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_1_MHL()
	{
		BIT_u3_8bitRegister(1, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_2_MHL()
	{
		BIT_u3_8bitRegister(2, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_3_MHL()
	{
		BIT_u3_8bitRegister(3, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_4_MHL()
	{
		BIT_u3_8bitRegister(4, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_5_MHL()
	{
		BIT_u3_8bitRegister(5, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_6_MHL()
	{
		BIT_u3_8bitRegister(6, Memory.ReadData(Registers.GetHL()));
	...
	int CPU::BIT_7_MHL()
	{
		BIT_u3_8bitRegister(7, Memory.ReadData(Registers.GetHL()));
